...
task("withdraw-protocol-funds", "withdraw ETH and LINK from StakeAcrossVaultProtocol.sol")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const bnmTokenContract = await ethers.getContractAt("ERC20", bnmToken)
   ...
   Protocol Contract's Eth balance : ${await ethers.provider.getBalance(protocolContract.address)}
   `)
    ...
    const withdrawEthTx = await protocolContract.withdrawEth({ gasLimit: 500_000 })
